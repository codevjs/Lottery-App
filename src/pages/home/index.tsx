              ...
              <Row gutter={[10, 10]}>
                <Col xs={24} sm={24} md={12}>
                  <Form.Item
                    ...
                    name={"doorprize"}
                    rules={[
                      { required: true, message: "Silahkan pilih dooprize" },
                    ]}
                    style={{ textAlign: "left" }}
                  >
                    <Select size={"large"}>
                      <Select.Option value={"Logam Mulia"}>
                        Logam Mulia
                      </Select.Option>
                      <Select.Option value={"10 Voucher Wokee @ Rp. 500rb"}>
                        10 Voucher Wokee @ Rp. 500rb
                      </Select.Option>
                    </Select>
                  </Form.Item>
                </Col>
                <Col xs={24} sm={24} md={12}>
                  <Form.Item
                    ...
                    name={"winners"}
                    rules={[
                      { required: true, message: "Tentukan jumlah pemenang" },
                    ]}
                  >
                    <InputNumber
                      style={{ width: "100%" }}
                ...
                <Col span={24}>
                  <Upload.Dragger beforeUpload={beforeUpload} fileList={[]}>
                    ...
                    <p className="ant-upload-text">
                      Klik atau seret file data karyawan ke area ini.
                    </p>
                    <p className="ant-upload-hint">
                      {dataLot.customers.length} Karyawan yang terdaftar.
                    </p>
                  </Upload.Dragger>
                </Col>
                <Col span={24}>
